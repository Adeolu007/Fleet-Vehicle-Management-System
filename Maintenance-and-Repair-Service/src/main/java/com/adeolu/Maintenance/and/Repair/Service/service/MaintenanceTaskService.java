...
//                .orElseThrow(() -> new VehicleNotFoundException("Vehicle not found"));
        ...
        maintenanceTask.setVehicle(maintenanceTask.getVehicle());
        ...
        return ResponseEntity.ok(MaintenanceTaskDto.builder().vehicle(maintenanceTask.getVehicle()).description(maintenanceTask.getVehicle())
